...
# Load configuration
damBreakCfg = os.path.join('ana1Tests', 'damBreak_com1DFACfg.ini')
...
hL, hR, uR, phi = damBreak.damBreakSol(avaDir, cfgMain, cfgGen)
...
outDir = os.path.join(avaDir, 'Outputs', 'test3Num')
