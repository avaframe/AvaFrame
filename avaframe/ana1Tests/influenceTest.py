...
def mainInfluenceTest(avalancheDir, influenceTestCfg, simDF, resAIMEC, pathDict):
    ...
    runoutArray, MMPPRArray, MMPFDArray, refArray = outInfluenceTest.analyzeResults(simDF, avalancheDir, IDList, refID, parameter2Study, visc2Study, otherParamValueList, otherParamNameList, xAxisArray)
    outInfluenceTest.plotResults(avalancheDir, parameter2Study, visc2Study, otherParamNameList,
