...
planeinclinationAngle = planeinclinationAngleDeg * Pi /180  # plane inclination
bedFrictionAngle = bedFrictionAngleDeg * Pi /180  # basal angle of friction. 16deg in samosAT
internalFrictionAngle = internalFrictionAngleDeg * Pi /180  # internal angle of friction phi>delta. 35deg in samosAT
