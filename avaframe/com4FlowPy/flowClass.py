...
# =============================================================================
    ...
    def calc_distribution(self):
        ...
        count = ((0 < self.dist) & (self.dist < threshold)).sum() # HERE IS A BIG BUG!!!
        # count is the number of dead cells (not enough flux to go further), BUT
        #it should be the number of alife cells (which can distribute further flux!)
