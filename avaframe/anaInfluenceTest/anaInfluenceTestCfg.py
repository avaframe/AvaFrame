### Config File - This file contains the main settings for the influence test
# This file will be overridden by local_anaInfluenceTestCfg.ini if it exists
# So copy this file to local_com2ABCfg.ini, adjust your variables there
...
#+++++++++++++ Output++++++++++++
# desired result Parameters (ppr, pfd, pfv, FD, FV, P, Vx, Vy, Vz, particles) - separated by |
resType = ppr|pfd|pfv
...
smallAva = False
 # if custom avalanche set is wanted switch to True and specify your parameters
customParam = False
# If customParam is True use (put your parameters here):
k1 = 1.05
k2 = -3130.0
k3 = 0.0
k4 = -2.38
