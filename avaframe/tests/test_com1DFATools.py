...
def test_updateResCoeffFields(tmp_path):
    ...
    fields = {'cResRasterOrig': cResRasterOrig,
              'detRasterOrig': detRasterOrig,
              'FV': FV,
              'FT': FT,
              }
    dem = {'originalHeader': {'ncols': 10, 'nrows':  4, 'xllcenter':  1000.00, 'yllcenter': -5000.00,
                              'cellsize':  5, 'nodata_value': -9999.00, "driver": "AAIGrid"}}
    ...
    fields = com1DFATools.updateResCoeffFields(fields, cfg['GENERAL'], 0., dem)
