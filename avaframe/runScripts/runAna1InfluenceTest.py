...
from avaframe.ana1Tests.ana1TestsCheckIniFiles import ana1TestsCheckIniFiles
...
ana1TestsCheckIniFiles(influenceTestCfg, visc2Study)
...
_, _, _, simDF = com1DFA.com1DFAMain(avalancheDir, cfgMain, cfgFile=visc2StudyCfg)
...
if ref=='dfa':
    ...
    _, _, _, simDF = com1DFA.com1DFAMain(avalancheDir, cfgMain, cfgFile=refCfg)
...
pathDict, _, resAnalysisDF = runAna3AIMEC.runAna3AIMEC(avalancheDir)

# Run influenceTest
simDF = influenceTest.mainInfluenceTest(avalancheDir, influenceTestCfg, simDF, resAnalysisDF, pathDict)
