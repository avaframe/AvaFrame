...
avaList = ['avaAlr1', 'avaHit1', 'avaKot1', 'avaMal1', 'avaWog1', 'avaGar1', 'avaHelixChannel', 'avaHelix',
           'avaBowl', 'avaFlatPlane', 'avaParabola', 'avaHockeySmall']
...
logName = 'runCompareCom1DFAOrigvsCom1DFANull'

# Load settings from general configuration file
cfgMain = cfgUtils.getGeneralConfig()

# Set directory for full standard test report
outDirReport = pathlib.Path.cwd() / 'tests' / 'reportscom1DFAOrigvsCom1DFANull'
fU.makeADir(outDirReport)

# Start writing markdown style report for standard tests
reportFile = outDirReport / 'com1DFAOrigvsCom1DFANull.md'
