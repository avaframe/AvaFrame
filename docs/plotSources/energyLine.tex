...
\draw [>={Triangle},thick, <->] (A) -- (A1) node [midway,below,black] {$\epsilon_r$};
...
%\node[text width=2.5cm, fill=none,below,black] at (2,-0.2) {$\mbox{run-out point}$};
%\draw [>={Triangle},thick, ->] (2,-0.2) -- (AA);
\end{tikzpicture}
